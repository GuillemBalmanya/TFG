...
<xsl:stylesheet version="3.0"
	...
	<xsl:template match="/" name="xsl:initial-template">
		...
		<xsl:text>nonTextualtUuid;TypePureId;TypeUri;Type_ca_ES;Type_en_GB;Type_es_ES;Title;ExtenalId;HostPublicationTitle;Edition;ISBN;CategoyrPureId;CategoryUri;Category_ca_ES;Category_en_GB;Category_es_ES;Language;PlaceOfPublication;Publisher;PublicationSerie;Volume;WorkflowStep;CreatedDate;CreatedBy</xsl:text>
		<xsl:value-of select="$newline" />
		<xsl:for-each select="$json-xml/fn:map/fn:array[@key='items']/fn:map[fn:string[@key='typeDiscriminator']='NonTextual']">

...
<xsl:stylesheet version="3.0"
	...
	<xsl:template match="/" name="xsl:initial-template">
		...
		<xsl:text>baUuid;baTypePureId;baTypeUri;baType_ca_ES;baType_en_GB;baType_es_ES;baTitle;baExtenalId;baTitle2;baEdition;baISBN;baCategoyrPureId;baCategoryUri;baCategory_ca_ES;baCategory_en_GB;baCategory_es_ES;baLanguage;baPlaceOfPublication;baPublisher;baPublicationSerie;baVolume;baWorkflowStep;baCreatedDate;baCreatedBy</xsl:text>
		<xsl:value-of select="$newline" />
		<xsl:for-each select="$json-xml/fn:map/fn:array[@key='items']/fn:map[fn:string[@key='typeDiscriminator']='BookAnthology']">

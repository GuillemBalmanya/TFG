<!--Aquest xslt ens porta les activitats de tipus visitOther (estades) codi ESF. Cal relacionar-la amb activities-persons
...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:uab="http://www.uab.cat">
	...
	<xsl:template match="/">
		...
		<xsl:for-each select="result/items/visitOther">
...
<!--entitat on fa l estada-->
			<xsl:value-of select="associatedExternalOrganisation/@uuid"/>
			<xsl:value-of select="$separator" />			

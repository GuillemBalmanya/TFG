	...
	<xsl:template match="/">    
        ...
        <xsl:for-each select="result/items/externalOrganisation">
			...
			<!--poblacio de l'entitat-->	
				<xsl:value-of select="uab:clean(address/address1)"/>			

<!--Aquest xslt ens porta les activitats de tipus membership (membre d'una organitzacio etc) codi PCR. Cal relacionar-la amb activities-persons
...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:uab="http://www.uab.cat">
	...
	<xsl:template match="/">
		...
		<xsl:for-each select="result/items/membership">

...
<xsl:stylesheet version="3.0"
	...
	<xsl:template match="/">
		...
		<xsl:for-each select="$json-xml/fn:map/fn:array[@key='items']/fn:map">
			...
			<!-- Recorrem les relatedApplications - sol·licituds vinculades a l'ajut concedit -->
			<xsl:for-each select="fn:array[@key='relatedApplications']/fn:map">
				...
				<!--dades de les relatedApplications-->
